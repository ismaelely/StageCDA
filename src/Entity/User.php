...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Blog::class, mappedBy="parent")
     */
    private $blogs;

    /**
     * @ORM\OneToMany(targetEntity=Actualites::class, mappedBy="parent")
     */
    private $actualites;

    /**
     * @ORM\OneToMany(targetEntity=Formations::class, mappedBy="parent")
     */
    private $formations;
    ...
    public function removeActualite(Actualites $actualite): self
    {
        if ($this->actualites->removeElement($actualite)) {
            // set the owning side to null (unless already changed)
            if ($actualite->getParent() === $this) {
                $actualite->setParent(null);
            }
        }
